...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Restaurant.inspection_count'
        db.add_column(u'restaurant_restaurant', 'inspection_count',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Restaurant.inspection_count'
        db.delete_column(u'restaurant_restaurant', 'inspection_count')
